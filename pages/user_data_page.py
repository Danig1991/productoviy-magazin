...
class UserDataPage(Expectation):
    ...
    # заголовок "Оформление заказа: Данные пользователя"
    ...
    # нажать кнопку "Обратно в магазин"
    def click_button_back_to_shop(self):
        button_back_to_shop = self.visibility_of_element_located(BUTTON_BACK_TO_SHOP_LOCATOR, "Обратно в магазин")
